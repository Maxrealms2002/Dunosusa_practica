            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    ...
                    <!-- Navbar Header--><a href="<?php echo base_url(); ?>Admin/Listar" class="navbar-brand">
                        <div class="brand-text brand-big visible"><strong class="text-primary">DUNOSUSA <sup>TM</sup></strong><strong class="text-white"></strong></div>
                        <div class="brand-text brand-sm"><strong class="text-primary">DUNO</strong><strong></strong></div>
                    </a>
                    <!-- Sidebar Toggle Btn-->
                    <button class="sidebar-toggle"><i class="fas fa-arrow-alt-circle-left"></i></button>
                </div>
                <div class="right-menu list-inline no-margin-bottom">
                    <h4>Primero voy a Dunosusa <strong class="text-primary"> <?php echo date("d-M-Y") ?></strong></h4>
                </div>
    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header d-flex align-items-center p-1">
                <div class="avatar" data-toggle="modal" data-target="#cambiarPass"> <i class="fas fa-user fa-3x"></i></div>
                <div class="title">
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="<?php echo base_url(); ?>Productos/Listar"> <i class="fab fa-product-hunt"></i> <strong class="text-white"> Productos - Proveedor </strong></a></li>
