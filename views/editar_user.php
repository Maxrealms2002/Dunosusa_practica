            ...
            <div class="modal-body">
                ...
                <form id="editUser<?php echo $fila['id']; ?>" method="POST">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select name="id_rol" id="id_rol" class="form-control" required>
                                    ...
                                    <option <?php echo $fila['id_rol'] === '2' ? 'selected' : ''; ?> value="2">Administrador Segundo</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" onclick="editarUser(<?php echo $fila['id']; ?>)">Guardar</button>
