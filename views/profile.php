                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card">
                            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                ...
                                <img src="../img/6.svg" alt="Profile" class="rounded-circle">
                            ...
                            <div class="card-body pt-3">
                                ...
                                <div class="tab-content pt-2">
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <p class="small fst-italic">DUNOSUSA</p>
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Nivel de usuario</div>
                                    ...
                                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                        ...
                                        <form id="form">
                                            ...
                                            <div class="row mb-3">
                                                <label for="company" class="col-md-4 col-lg-3 col-form-label">Correo electronico</label>
                                                <div class="col-md-8 col-lg-9">
